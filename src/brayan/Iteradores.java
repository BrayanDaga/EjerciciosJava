...
Aunque Iterator no permite reemplazar directamente, combina un ListIterator para reemplazar los nombres de todos los Cliente cuyo nombre sea "Invitado" por "Cliente Anónimo".*/
	}
}
